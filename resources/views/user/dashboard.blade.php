            ...
            <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
                <div
                    ...
                    <div class="flex-auto p-4">
                        ...
                        <h6 class="mt-6 mb-0 ml-2">Jumlah Alumni</h6>
                        <p class="ml-2 leading-normal text-sm"><span class="font-bold">Berdasarkan Minat</span></p>
                            ...
                            <div class="flex flex-wrap mt-0 -mx-3">
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-xs">Data Mining</p>
                                    </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-xs">RPL</p>
                                    </div>
                                ...
                                <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                    <div class="flex mb-2">
                                        ...
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-xs">Jaringan</p>
                                    </div>
